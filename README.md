...
<head>
    ...
    <title>Vocab Practice: Community & Life</title>
    <style>
        :root {
...
<header>
    <h1>Vocabulary: Modern Living</h1>
...
<script>
    const data = [
        { word: "jumper", def: "A warm piece of clothing with long sleeves (a sweater).", sent: "It's cold outside, so I'm wearing a wool ___.", pron: "That's a very nice blue ___." },
        { word: "town hall", def: "A public building used for local government offices.", sent: "We need to go to the ___ to get our marriage license.", pron: "The meeting is at the ___." },
        { word: "charity shop", def: "A store that sells donated items to raise money.", sent: "I found this vintage jacket at a local ___.", pron: "I donate my old books to the ___." },
        { word: "brick-and-mortar", def: "A physical store building, rather than an online shop.", sent: "Many online brands are now opening ___ stores.", pron: "I prefer shopping in a ___ shop." },
        { word: "clothing", def: "Items worn on the body; clothes.", sent: "The store sells high-quality outdoor ___.", pron: "We need to pack warm ___." },
        { word: "relatives", def: "People who are in the same family as you.", sent: "All my ___ are coming over for Christmas dinner.", pron: "I have many ___ in London." },
        { word: "backache", def: "A prolonged pain in the back.", sent: "Sitting at a desk all day gives me a terrible ___.", pron: "I have a slight ___ today." },
        { word: "accustomed", def: "Familiar with something; used to something.", sent: "I am not ___ to waking up so early in the morning.", pron: "He is ___ to the cold weather." },
        { word: "thunderstorm", def: "A storm with thunder, lightning, and heavy rain.", sent: "The loud thunder during the ___ woke up the dog.", pron: "There is a ___ coming." },
        { word: "overcome", def: "To succeed in dealing with a problem or difficulty.", sent: "She had to ___ many obstacles to finish her degree.", pron: "You can ___ your fears." },
        { word: "cycling", def: "The activity of riding a bicycle.", sent: "___ is a great way to stay fit and see the city.", pron: "I go ___ every weekend." }
    ];
    ...
    function checkWriting() {
        data.forEach((item, i) => {
            ...
            if (val === target) {
                ...
                fb.innerHTML = `<span class="status-yellow">⚠️ Close! It is "${item.word}"</span>`;
                totalScore += 0.5;
            } else {
    ...
    function testSpeech(word, idx) {
        ...
        rec.onresult = (e) => {
            ...
            const target = word.toLowerCase().replace('-', ' ');
